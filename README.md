...
If you can't find a program I use, there is a `readme.txt` in each sub-directory in `tools` that explains some things. There is a `readme.txt` in all sub-directories btw, but the other ones are mostly for fun.
